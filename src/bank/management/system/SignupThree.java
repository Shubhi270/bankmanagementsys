...
SignupThree(String formno){
    ...
    JLabel number=new JLabel("XXXX-XXXX-4184");
    ...
    pindetail.setBounds(100,400,300,10);
    add(pindetail);
    ...
    c7= new JCheckBox("I HEREBY DECLARE THAT THE ABOVE ENTERED DETAILS ARE CORRECT AND TO THE BEST OF MY KNOWLEDGE.");
    ...
    if(ae.getSource()==submit){
        ...
        try{
            if (accountType.equals("")){
                JOptionPane.showMessageDialog(null,"Accpunt Type is required.");
            }
            else {
                Conn conn=new Conn();
